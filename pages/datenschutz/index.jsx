...
// Styling
import { ContentStyles, GutenbergPageStyles, WPBlockStyles } from '../../styles/global-components.styles';
            ...
            >
                <section>
                    {/* <ContentStyles className="bs-content"> */}
                        <GutenbergPageStyles className="bs-content-inner">
                            { blocks.map( (block, i) => (
                                getWordpressBlock( 
                                    block, 
                                    i, 
...
export const getStaticProps = async() => {
    ...
    const page = pages.filter( (page) => (page.slug === 'datenschutz') );
